...
//    int64_t dimension = bin_to_int_digit(binary_data, 4, 0);
...
//    for (int i = 0; i < kmeans.N; i++)
//    {
//        print_vector(kmeans.vector[i], output_file);
//        if (i < (kmeans.N - 1))
//            fprintf(output_file, ", ");
//    }
//    fprintf(output_file, "]\"\n\n");*/
...
//        kmeans_run(init_centroid, kmeans, output_file);
//
//        vector_destroy(&init_centroid, kmeans.k);
//    }
//
...
int main()
{
    ...
    int picking_limit = 10;
    bool quiet = false;
    input_file = fopen("F:\\OutSource\\PYTHON\\PY2C\\test_thread\\x64\\Debug\\testb.bin", "rb");
    output_file = fopen("F:\\OutSource\\PYTHON\\PY2C\\test_thread\\x64\\Debug\\tedddd.csv", "w");
